...
- (void)viewDidLoad {
  [super viewDidLoad];
  // Create a dummy rect to lay out the overlay within initially. This will be updated when the
  // GMSMapView is added to this UIViewController and layoutSubviews is called.
  CGRect outlineFrame = CGRectMake(0, 0, 250, 250);
  GMSCameraPosition *camera = [GMSCameraPosition cameraWithLatitude:-37.81969
                                                          longitude:144.966085
                                                               zoom:4];
  mapView_ = [GMSMapView mapWithFrame:outlineFrame camera:camera];
  ...
  CGRect overlayFrame = CGRectMake(CGRectGetMinX(outlineFrame),
                                   CGRectGetMaxY(outlineFrame),
                                   CGRectGetMaxX(outlineFrame),
                                   0);
